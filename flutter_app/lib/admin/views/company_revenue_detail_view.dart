...
class _CompanyRevenueDetailScreenState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Company Revenue', style: TextStyle(color: Colors.white)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildDateField('Start Date', startDate, (pickedDate) {
              setState(() {
                startDate = pickedDate;
              });
            }),
            SizedBox(height: 16),
            _buildDateField('End Date', endDate, (pickedDate) {
              setState(() {
                endDate = pickedDate;
              });
            }),
