...
class UserReportScreenView extends StatefulWidget {
  ...
  const UserReportScreenView(
      {Key? key, required this.users, required this.viewModel})
      : super(key: key);
...
class _UserReportScreenViewState extends State<UserReportScreenView> {
  ...
  Widget build(BuildContext context) {
    List<User> filteredUser = widget.users.where((user) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Thông tin nguời dùng'),
      ),
      body: Column(
        children: [
          ExpansionTile(
