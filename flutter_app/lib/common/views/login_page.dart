        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              SizedBox(height: 100),
              Image(
                image: AssetImage('assets/common/icontaxi.png'),
                width: 200,
                height: 60,
              ),
              Padding(
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Container(
                    width: 50,
                    child:
                        Icon(Icons.lock, color: Colors.grey.withOpacity(0.6)),
                  ),
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.all(Radius.circular(6)),
                    borderSide: BorderSide(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          decoration: TextDecoration
                              .underline, // Thêm gạch chân để giống liên kết
                        ),
                      ),
                    ),
                  ]),
                  ...
                  child: InkWell(
                    ...
                    onHighlightChanged: (value) {
                      setState(() {
                        if (value) {
                          _backgroundColor =
                              Colors.red; // Thay đổi sang màu đỏ khi nhấn
                        } else {
                          _backgroundColor = Colors.grey
                              .shade700; // Trở lại màu ban đầu khi không nhấn nữa
                        }
                      });
                    },
                    child: Text(
